...
LOCK TABLES `ibancarias` WRITE;
/*!40000 ALTER TABLE `ibancarias` DISABLE KEYS */;
INSERT INTO `ibancarias` VALUES ('Ita̼',499,22,1022,'54642-1',1,'');
/*!40000 ALTER TABLE `ibancarias` ENABLE KEYS */;
UNLOCK TABLES;
